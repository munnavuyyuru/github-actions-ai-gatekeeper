...
// Testing our new Gatekeeper Agent
const databaseSecretKey = "super_secret_password_12345!";

export function getUserData(userInputId: string) {
  // A classic SQL injection pattern that the AI should catch
  const rawQuery = `SELECT * FROM users WHERE id = '${userInputId}'`;
  return rawQuery;
}
